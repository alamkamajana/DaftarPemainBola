...
public class GridBolaAdapter extends RecyclerView.Adapter<GridBolaAdapter.GridViewHolder> {
    ...
    public GridBolaAdapter(Context context) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_bola, parent, false);
